...
- 2026-07-01: CRDO sell limit $261.33 and ALAB buy limit $450.22 both submitted 10:00 AM during calm, market gap-downed mid-day (-3% by 15:00) and left limits stranded. Morning calm → afternoon volatility is a one-way trap: limits set relative to quiet open prices become uncompetitive during selloffs. Action: if expecting volatile catalyst windows (earnings, jobs report, central bank), widen morning limit price by 0.3–0.5% above/below ask, or mark order for re-submission if intraday vol spikes >2%.
